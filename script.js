...
const results = {
  ST: { type: "보안 설계자", sub: "The Architect", mascot: "bee.png", tags: ["#소통중심", "#어드바이저", "#유연함", "#리스크관리"], desc: "보안은 잘 짜인 시스템과 자동화된 기술로 완성된다고 믿습니다. 명확한 정책을 수립하고, 강력한 기술적 통제로 사람이 개입할 여지를 최소화하여 잠재적 위협을 원천 차단하는 것을 가장 중요하게 생각합니다.", best_code: "SP", worst_code: "AP" },
  SP: { type: "규정 수호자", sub: "The Guardian", mascot: "guardian.png", tags: ["#소통중심", "#어드바이저", "#유연함", "#리스크관리"], desc: "잘 만든 정책과 규정, 그리고 그것을 따르는 사람들의 노력이 합쳐질 때 가장 안전하다고 믿습니다. 기술은 보조적인 수단이며, 결국 보안은 사람이 만들어나가는 문화이자 프로세스라고 생각합니다. 당신의 꼼꼼함이 모두를 구원합니다.", best_code: "ST", worst_code: "AT" },
  AT: { type: "기술 해결사", sub: "The Specialist", mascot: "specialist.png", tags: ["#소통중심", "#어드바이저", "#유연함", "#리스크관리"], desc: "규정이나 정책보다 현장에서의 기술적인 판단과 대응 능력이 더 중요하다고 믿습니다. 어떤 위협이든 깊이 있는 기술 전문성으로 분석하고 해결할 수 있다는 자신감을 가지고 있으며, 실제 상황에서의 빠른 조치를 선호합니다.", best_code: "AP", worst_code: "SP" },
  AP: { type: "보안 어드바이저", sub: "The Advisor", mascot: "advisor.png", tags: ["#소통중심", "#어드바이저", "#유연함", "#리스크관리"], desc: "보안은 무조건 막는 것이 아니라, 비즈니스와 사람을 이해하며 위험을 '관리'하는 과정이라고 생각합니다. 동료들과의 소통을 통해 현실적인 대안을 찾고, 모두가 만족할 수 있는 접점을 만들어내는 역할에 가장 큰 가치를 둡니다.", best_code: "AT", worst_code: "ST" }
};
...
function showResult(resultTypeFromUrl = null) {
  ...
  resultPage.innerHTML = `
    <div class="result-card">
      <h3 id="result-summary">${result.sub}</h3> <!-- 🔧 CHANGED: summary → sub -->
...
function restartTest() {
  // 🔧 CHANGED: 완전 새로고침 대신 내부 상태 초기화 후 시작화면으로 복귀
  currentQuestionIndex = 0;
  userAnswers = new Array(questions.length).fill(null);
  resultContainer.classList.add('hide');
  qnaPage.classList.add('hide');
